 ...
 * DAO for table "Org".
*/
public class OrgDao extends AbstractDao<Org, String> {
    ...
    */
    ...
    protected void bindValues(SQLiteStatement stmt, Org entity) {
        ...
        stmt.bindString(2, entity.getPid());
    ...
    public void readEntity(Cursor cursor, Org entity, int offset) {
        ...
        entity.setPid(cursor.getString(offset + 1));
        entity.setName(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
    
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Org entity, long rowId) {
        return entity.getUid();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(Org entity) {
        if(entity != null) {
            return entity.getUid();
        } else {
            return null;
