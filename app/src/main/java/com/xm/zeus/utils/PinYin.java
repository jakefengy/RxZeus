...
public class PinYin {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(pinYin.toPinYin("傻鱼abc"));
            System.out.println(pinYin.toPinYin("傻鱼abc", "_"));
            System.out.println(pinYin.toPinYin("傻鱼abc", "_", Type.LOWERCASE));
